  ...
  <div class="app_container">
    ...
    <div class="table-container">
      ...
      <div class="box-right">
        ...
        <div>
          <el-row>
            <el-col :span="5"><div class="touxiangload">上传头像:</div></el-col>
            <el-col :span="19">
              <div class="touxiangbox">
                ...
                >
                  ...
                  <div class="touxiangWords">修改头像</div>
                </el-upload>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="5"><div class="nameload">您的姓名:</div></el-col>
            <el-col :span="19"
              ><div class="namebox">
                <el-input
                  v-model="input"
          ...
          <el-row>
            <el-col :span="5"><div class="nameload">您的手机号:</div></el-col>
            <el-col :span="19"
              ><div class="namebox">
                <el-input
                  v-model="input"
...
export default {
  ...
  methods: {
    ...
    handleAvatarSuccess(res, file) {
      ...
      this.touxiangURL = this.imageUrl;
    },
