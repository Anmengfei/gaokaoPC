    ...
    <div>
        ...
        <div class="switchTabs">
            <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
                ...
                <el-tab-pane :label="cjLable" name="first">
                   <cj-list></cj-list>
                </el-tab-pane>
                <el-tab-pane :label="wtLabel" name="second">
                    1233
                </el-tab-pane>
                <el-tab-pane :label="bdLabel" name="third">
                    12433
                </el-tab-pane>
...
import CjList from "../schoolRecommand/cjList";
export default {
    name: 'SchoolRecommand',
    components: { HomeHeader, Footer, CjList },
    data() {
        return {
            showAll: false,
            loginStatus: true,
